...
int write_pgm_image( void *image, int maxval, int xsize, int ysize, const char *image_name)
/*
 ...
 */
{
  ...
  // Writing file
  int written = fwrite( image, 1, xsize*ysize*color_depth, image_file);  
 ...
 */
{
  ...
  *xsize = *ysize = *maxval = 0;
  ...
  char   *line = NULL;
  char    MagicN[2]; /* swapping these two lines breaks and fixes stuff*/
